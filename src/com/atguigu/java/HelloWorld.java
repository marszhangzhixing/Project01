...
快捷鍵的使用
1 执行（run）   alt + r
2 提示不全（Class Name Completion）   alt + /
3 单行注释  ctrl + /
4 多行注释  ctrl + shift + /
...
31 查看文档的说明（quick documentation）     F2
32 收起所有的方法（collapse all）    alt + shift + c
33 打开所有方法（expand all）   alt + shift + x
34 打开代码所在硬盘文件夹（show in explorer）    ctrl + shift + x
35 生成try-catch（surround with） alt + shift + z
...
42 添加到收藏（add to favorities）     ctrl + alt + f
...
49 查看方法在哪里被调用（Call Hierarchy）   ctrl + shift + h
